...
echo 'export GOROOT=/usr/local/go' | bash #>> ~/.bash_profile
echo 'export GOPATH=$HOME/sites' | bash #>> ~/.bash_profile
echo 'export PATH=$GOPATH/bin:$GOROOT/bin:$PATH' | bash #>> ~/.bash_profile 
